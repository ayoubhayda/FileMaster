        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8  flex flex-row justify-between">
            ...
            <div class="relative mt-6 flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <div class="p-6">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="mb-4 h-12 w-12 text-sky-500">
                    ...
                    <p class="block font-sans text-base font-light leading-relaxed text-inherit antialiased h-20">
                        Effectuez toutes les opérations liées aux documents, telles que l'ajout, la modification, le
            ...
            <div class="relative mt-6 flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <div class="p-6">
                    ...
                    <p class="block font-sans text-base font-light leading-relaxed text-inherit antialiased h-20">
                        Effectuez toutes les opérations liées aux colis, telles que le remplissage des classeurs de
                        sortie et d'entrée.
                    </p>
                </div>
                <div class="p-6 pt-0">
            ...
            <div class="relative mt-6 flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                <div class="p-6">
                    ...
                    <p class="block font-sans text-base font-light leading-relaxed text-inherit antialiased h-20">
                        Effectuez toutes les opérations liées aux utilisateurs, telles que l'ajout, la modification et
                        la suppression.</p>
                </div>
                <div class="p-6 pt-0">
